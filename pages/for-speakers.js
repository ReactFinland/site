...
Prerecording also decreases technical risk for all parties (i.e. connectivity or other problems). If you want to prerecord, record your whole screen. You don't have to capture camera separately as it will be added live during the stream while we're playing the recording. Please send a link to the prerecording to "info at react-finland.fi" a day before your session. If possible, resolution should be Full HD (1080p) at least.
