...
const intro = `
React Finland is the largest React conference in the Nordics arranged 30.08-03.09, hybrid online. The conference begins with two workshop days and the following conference days include topics ranging from state management to emerging topics such as ReactVR and ReasonML.
`;
